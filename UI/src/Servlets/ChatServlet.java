...
import Handlers.ChatManager;
import Handlers.SingleChatEntry;
...
public class ChatServlet extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String username = SessionUtils.getUser(request).username;
        if (username == null) {
        ...
        logServerMessage("Server Chat version: " + chatManagerVersion + ", User '" + username + "' Chat version: " + 0);
